...
public class PostMovieRequest implements PostMovieContract.Model {
    @Override
    public void postMovie(OnFinishedListener onFinishedListener, PostMovie postMovie) {
        ...
        MultipartBody.Part Thumbnail = MultipartBody.Part.createFormData("Thumbnail",
        ...
        MultipartBody.Part CoverImage = MultipartBody.Part.createFormData("CoverImage",postMovie.getCoverImage().getName(),RequestBody.create(MediaType.parse("multipart/form-data"),postMovie.getCoverImage()));
        RequestBody Age = RequestBody.create(MediaType.parse("multipart/form-data"),postMovie.getAge());
        MultipartBody.Part Movie = MultipartBody.Part.createFormData("Movie",postMovie.getMovie().getName(),RequestBody.create(MediaType.parse("multipart/form-data"),postMovie.getMovie()));
        ...
        Call<ApiResponse<String[]>> call = apiService.PostMovie(
                MovieID,
                MovieName,
                Description,
                Thumbnail,
