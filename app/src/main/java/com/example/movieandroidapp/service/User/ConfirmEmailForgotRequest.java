...
public class ConfirmEmailForgotRequest implements ForgotPasswordContract.Model {
    @Override
    public void confirmEmail(OnFinishedListener onFinishedListener, String email_address) {
        ...
        Call<ApiResponse<String>> call = apiService.confirmEmailForgot(email_address);
